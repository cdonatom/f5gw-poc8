...
// bit 0x0080: ?? used to skip to set a bit in GLOBAL_FLAGS_REG2 when it is not zero in tx_timers_setup
	...
	#define 	TSF_DRIFT_ENABLE	r63
	#define 	TSF_TMP_0	r62
	#define 	TSF_TMP_1	r61
	#define 	TSF_TMP_2	r60
	#define 	TSF_TMP_3	r59
	#define 	DRIFT_DEBUG	r58
...
//
	...
	check_mac_status:;							
		...
		#define	DRIFT 	250
	check_conditions:;
		je 	TSF_DRIFT_ENABLE, 0x00, end_drift;
		
		or	SPR_TSF_WORD0, 0x000, TSF_TMP_0;				
		or	SPR_TSF_WORD1, 0x000, TSF_TMP_1;				
		or	SPR_TSF_WORD2, 0x000, TSF_TMP_2;				
		or	SPR_TSF_WORD3, 0x000, TSF_TMP_3;				
		jne	TSF_TMP_0, SPR_TSF_WORD0, check_conditions;
	update_TSF_TMP:;
		/*add.	TSF_TMP_0, DRIFT, GP_REG5;*/
		add.	TSF_TMP_0, TSF_DRIFT_ENABLE, GP_REG5;
		or 	GP_REG5, 0x0, SPR_TSF_WORD0;					
		addc.	TSF_TMP_1, 0x00, SPR_TSF_WORD1;	
		addc.	TSF_TMP_2, 0x00, SPR_TSF_WORD2;		
		addc.	TSF_TMP_3, 0x00, SPR_TSF_WORD3;	
		jne	GP_REG5, SPR_TSF_WORD0, update_TSF_TMP;				
		add	DRIFT_DEBUG,0x1,DRIFT_DEBUG
		mov 	0x00, TSF_DRIFT_ENABLE;
	end_drift:;
